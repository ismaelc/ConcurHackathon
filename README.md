...
**Concur + Pebble** | Use Pebble to confirm if purchase is personal or business - [see car mileage expense sample code here](https://developer.getpebble.com/blog/2014/09/03/Pebble-Concur-Mojio/) 
**Concur + Twilio** | Call/SMS a [Twilio](http://www.twilio.com/) number to submit your expense (voice through AVR or SMS) 
...
**Concur + Sinch** | When recommending places to eat near a user's hotel booking, users could click a button to call the restaurant in-app (using [Sinch](http://www.sinch.com/docs/overview/)) and make a reservation or ask a question about the food. 
**Concur + EvoSnap** | Create a simple POS application that sent the payment/transaction data to [EVO Snap*](http://evosnap.com) and also to Concur. 
